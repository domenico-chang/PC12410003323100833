...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=AO2300924;Database=TallerMecanico;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cliente>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Cliente__3214EC07E87E5071");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__OrdenSer__3214EC078E241757");
            ...
            entity.HasOne(d => d.TipoServicio).WithMany(p => p.OrdenServicio)
                ...
                .HasConstraintName("FK_TipoServicioId");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__TipoServ__3214EC079A550827");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Vehiculo__3214EC0761BA7D17");
